...
I/O 작업을 위해 기다리는 중인 프로세스

## 스케쥴러

### long-term 스케쥴러 (Job 스케쥴러)

어떤 프로세스가 레디 큐로 들어와야 하는지 선택
멀티프로그래밍의 정도를 결정한다

### short-term 스케쥴러 (CPU 스케쥴러)

어떤 프로세스가 실행되고 메모리를 할당받아야 하는지 선택

### mid-term 스케쥴러

어떤 프로세스가 스와핑(Swapped out/in) 되어야 하는지 선택
...
![sch_RR_quantum1](/images/sch_RR_quantum1.JPG "Round Robin")
